...
function BlogHome({ datas }) {
    ...
    return (
        <React.Fragment>
            <Headers title="Blog - itsben.space" />
...
export async function getServerSideProps({ res, query }) {
    ...
    return {
        props: {
            datas: JSON.parse(JSON.stringify(getDB.sort((a, b) => b.pubDate - a.pubDate))).filter(x => !x.link.includes('private') && !x.labels.includes("private"))
        }
    }
}
