      ...
      <div className="mx-auto max-w-3xl px-2 xl:max-w-5xl">
        <div className="flex h-screen flex-col justify-between">
          ...
          <div className="m-auto">
            <form
              className="group w-[100%] sm:w-[460px] bg-white drop-shadow-lg rounded px-8 pt-6 pb-8 mb-4 duration-100 border-1 border-slate-400   hover:shadow-xl"
            ...
            >
              ...
              <span
                id="warn"
                style={{ display: "none" }}
                className="mb-4 inline-block align-baseline font-bold text-sm text-red-500"
              ></span>
              <div className="flex items-center justify-between">
                <button
                  id="submit"
                  className="duration-300 animate-bounce transition hover:-translate-y-1 hover:scale-110 group-hover:animate-none bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline"
                >
                  Login
                </button>
              </div>
            </form>
            <p className="text-center text-gray-500 text-sm">benspace.xyz</p>
          </div>
          <Footer />
        </div>
      </div>
