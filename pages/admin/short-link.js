                    ...
                    <div className="relative rounded-lg shadow bg-gray-700">
                        ...
                        <form onSubmit={submitEdit}>
                            ...
                            <div className="px-4 py-2 space-y-2">
                                ...
                                <input id="id" autoComplete="off" name="newId" className="w-full bg-gray-200 appearance-none border-2 border-gray-200 rounded py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-gray-400" type="text" required />
                            </div>
